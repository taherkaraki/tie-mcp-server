...
export type EdgeKind =
  ...
  | 'ReusedPassword'; // principal <-> shared-password hub (shares a password hash with the cluster)
...
export interface RawEdge {
  ...
  via: 'member' | 'primaryGroup' | 'delegation' | 'rbcd' | 'sidHistory' | 'gplink' | 'dacl' | 'owner' | 'containment' | 'gpoScope' | 'domainControls' | 'passwordReuse';
